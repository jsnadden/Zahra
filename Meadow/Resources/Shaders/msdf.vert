...
layout(location = 4) in vec4 a_BackgroundColour;
//layout(location = 5) in vec4 a_OutlineColour;
...
layout(location = 3) out vec4 v_BackgroundColour;
//layout(location = 4) out vec4 v_OutlineColour;
